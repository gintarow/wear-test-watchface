...
package com.gintarow.wearable.mondainewatchface;
 ...
 *
 * {@link com.gintarow.wearable.mondainewatchface.MondaineWatchFaceService} is similar but has a ticking second hand.
 */
public class Stop2GoAmbentBlackWatchFaceService extends CanvasWatchFaceService {
...
//		static final int MSG_UPDATE_TIME = 0;
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(Stop2GoAmbentBlackWatchFaceService.this)
            ...
            Resources resources = Stop2GoAmbentBlackWatchFaceService.this.getResources();
...
//            if (isVisible() && !isInAmbientMode()) {
        ...
        private void registerReceiver() {
            ...
            Stop2GoAmbentBlackWatchFaceService.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            Stop2GoAmbentBlackWatchFaceService.this.unregisterReceiver(mTimeZoneReceiver);
        }
